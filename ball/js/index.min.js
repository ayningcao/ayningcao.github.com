"undefined" == typeof window.define && (window.define = function () {}, window.define.amd = 1), "undefined" == typeof window.$AJB && (window.$AJB = {}), $AJB.lib = {}, $AJB.general = {}, $AJB.page = {},
    function (a) {
		...
		var times = new Array("石器时代", "陶器时代", "青铜时代", "瓷器时代", "铁器时代", 
				"蒸汽时代", "电器自动化时代", "现代网络时代", "未来机器人时代")
        function a(a) {
            function c() {
                b(i, "click", function () {
                    f.fire(h, g)
            ...
            var i = a.getElementsByClassName("button")[0],
                ...
                l = {
                    show: function () {
                        ...
                        var d = a,
                            c = c ? c : 0;
                        j.innerHTML = times[parseInt(d/7)] + " " + d;
        ...
        function f() {
            t(document.body, "mousedown", function (a) {
                ...
                m.switchStage(0, function () {
					...
					var t = parseInt(W/7)
					console.log("current times is " + t)
					if (t >= 0 && t <= 8) {
						document.getElementById("bdy").style.backgroundImage = "url('img/" + t + ".jpg')"
					}
                })
        ...
        function i(a) {
            wx.config({
                ...
                wx.onMenuShareAppMessage({
                    ...
                    link: S,
                    imgUrl: U,
                    trigger: function () {}, success: function () {
                        var a = new Object;
        ...
        function j() {
            v.isWeixin ? x.post("http://timelineapp.pointstone.org/ci/authorize/get_jssdk_info", {
                ...
                var b = JSON.parse(a);
                b.sess_openid != v.getOpenid() && (location.href = S), s.load(v.getOpenid(), function (a) {
                    var a = JSON.parse(a);
                    a.level && a.level > W ? (e(a.level), z.popup("云端关卡同步完毕！")) : s.save(W)
                }), i(b)
            }) : location.search && (location.href = location.pathname)
        }
        ...
        var l, m, n, o, p = $AJB.general.Scene(),
            ...
            O = 60,
            P = "core-ball-level",
            Q = "很久以前 只是家烤串店 我已经玩到#{level}关了!",
            R = "sinaweibo://share?content=很久以前，我已玩到第#{level}关了，你也来试试吧！ http://timelineapp.pointstone.org/coreball/",
